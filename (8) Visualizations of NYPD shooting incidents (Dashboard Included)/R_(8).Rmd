...
```{r plot_1, echo=TRUE, fig.height=6, fig.width=10, warning=FALSE}
# Plot map
...
```{r plot_2, echo=TRUE, fig.height=6, fig.width=10, warning=FALSE}
# Plot
...
```{r plot_3, echo=TRUE, fig.height=9, fig.width=9, warning=FALSE}
# Plot
...
### Sankey Network Graph with links between the year and number of shootings for Perpator sex. For a subset of total for simpler plotting. M is Male, U is Unknown.
```{r 4, include=FALSE}
...
```{r plot_4, echo=TRUE, fig.height=6, fig.width=10, warning=FALSE}
# Plot graph
...
```{r plot_5, echo=TRUE, fig.height=6, fig.width=10, warning=FALSE}
# Plot
tm_shape(times) + 
